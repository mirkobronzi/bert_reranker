    ...
    lsr = [
        {
            "params": _get_grad_params(
                model.bert_question_encoder.pre_pooling_net.parameters()
            ),
            "lr": ffw_lr,
        },
        {
            "params": _get_grad_params(
                model.bert_paragraph_encoder.pre_pooling_net.parameters()
            ),
            "lr": ffw_lr,
        },
        {
            "params": _get_grad_params(
                model.bert_question_encoder.post_pooling_net.parameters()
            ),
            "lr": ffw_lr,
        },
        {
            "params": _get_grad_params(
                model.bert_paragraph_encoder.post_pooling_net.parameters()
            ),
            "lr": ffw_lr,
        },
    ]
